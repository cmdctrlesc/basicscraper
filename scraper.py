...
for div in divs:
    for element in div.find_all("img"):
        pic_url = element['src']
        if pic_url not in logo_urls:
        #avoid adding duplicates

            logo_urls.append(pic_url) 
...
multiline_string = ''.join([url + '\n' for url in logo_urls])
#create a multiline string from the list of image urls
